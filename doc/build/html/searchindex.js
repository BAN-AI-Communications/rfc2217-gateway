Search.setIndex({
  ...
  filenames : [ "index.rst" ],
  objects : {
    "" : {mdns_advertiser : [ 0, 0, 0, "-" ]},
    "mdns_advertiser.MDNSAdvertiser" : {
      get_network_ip_address : [ 0, 2, 1, "" ],
      start : [ 0, 2, 1, "" ],
      stop : [ 0, 2, 1, "" ]
    },
    mdns_advertiser : {MDNSAdvertiser : [ 0, 1, 1, "" ]}
  },
  objnames : {
  ...
  titles : [ "Welcome to instrumentserver2\u2019s documentation!" ],
  titleterms : {
    document : 0,
    indic : 0,
    instrumentserver2 : 0,
