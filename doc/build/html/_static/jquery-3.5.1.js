...
var Sizzle =
    ...
    (function(window) {
          ...
          funescape =
            ...
            return nonHex ?
                       ...
                       nonHex
                          ...
                          // encoded Unicode code point Support: IE <=11+ For
                          // values outside the Basic Multilingual Plane (BMP),
                          // manually construct a surrogate pair
        ...
        if (!seed) {
          ...
          if (documentIsHTML) {
            ...
            if (support.qsa && !nonnativeSelectorCache[selector + " "] &&
              ...
              // context. The technique has to be used as well when a leading
              // combinator is used as such selectors are not recognized by
              // querySelectorAll. Thanks to Andrew Dupont for this technique.
              if (nodeType === 1 &&
      ...
      setDocument = Sizzle.setDocument = function(node) {
        ...
        // errors (jQuery #13936) Support: IE 11+, Edge 17 - 18+ IE/Edge
        // sometimes throw a "Permission denied" error when strict-comparing two
        // documents; shallow comparisons work. eslint-disable-next-line eqeqeq
        ...
        // <=3.6 - 31 only, Safari 4 - 5 only, Opera <=11.6 - 12.x only IE/Edge
        // & older browsers don't support the :scope pseudo-class. Support:
        // Safari 6.0 only Safari 6.0 supports :scope but it's an alias of :root
        // there.
      ...
      */
        ...
        if ((support.qsa = rnative.test(document.querySelectorAll))) {
          ...
          assert(function(el) {
            ...
            // IE 11/Edge don't find elements on a `[name='']` query in some
            // cases. Adding a temporary attribute to the document before the
            // selection works around the issue. Interestingly, IE 10 & older
      ...
      */
        ...
        sortOrder = hasCompare ? function(a, b) {
          ...
          if (compare & 1 || (!support.sortDetached &&
            ...
            // document Support: IE 11+, Edge 17 - 18+ IE/Edge sometimes throw a
            // "Permission denied" error when strict-comparing two documents;
            // shallow comparisons work. eslint-disable-next-line eqeqeq
            if (a == document ||
      ...
      Expr = Sizzle.selectors = {
        ...
        pseudos : {
          ...
          "last" : createPositionalPseudo(function(
              _matchIndexes, length) { return [ length - 1 ]; }),

          "eq" :
              createPositionalPseudo(function(_matchIndexes, length, argument) {
